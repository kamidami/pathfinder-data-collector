...
templates do not establish nullability. No scraper, HTTP fetcher, automated verification, web
UI, Pathfinder database integration, or AI feature exists yet. Human approval is mandatory
before export. The next phase is a policy-compliant safe HTTP fetcher.
